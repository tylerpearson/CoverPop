(function(f){var d={coverId:"CoverPop-cover",expires:30,closeClassNoDefault:"CoverPop-close",closeClassDefault:"CoverPop-close-go",cookieName:"_CoverPop",onPopUpOpen:null,onPopUpClose:null,forceHash:"splash",delayHash:"go",closeOnEscape:true,debug:false},g={html:document.getElementsByTagName("html")[0],cover:document.getElementById(d.coverId),closeClassDefaultEls:document.querySelectorAll("."+d.closeClassDefault),closeClassNoDefaultEls:document.querySelectorAll("."+d.closeClassNoDefault)},c={hasClass:function(a,
